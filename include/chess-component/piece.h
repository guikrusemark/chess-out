 ...
 * @file piece.h
 * @author
 * @brief Virtual class, to be inherited by all pieces, and to be used as a base class for manipulation on board. 
 *      It is responsible by storage scope for movements and informations to pass messages to the cells.
 *      It uses PAWN type as default for preventing issues and inexpected behavior, but it can be changed to any other type.
 *
 */

// TODO - Add a way to check if the piece is in check, and if it is, then it can't move to a cell that is in check.
// TODO - Add a way to check if the piece is in checkmate, and if it is, then it is a loss.
// TODO - Add a way to check if the piece is in stalemate, and if it is, then it is a draw.
...
class Piece {
    ...
    public:
        ...
        std::string getName();
        /**
         * @brief Get a string version of color name (white, black). To be easier to show on presenter.
         * 
